...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuChange_Seaborn_Style = QMenu(self.menuFigure)
        self.menuChange_Seaborn_Style.setObjectName(u"menuChange_Seaborn_Style")
        self.menuSeaborn_Theme = QMenu(self.menuFigure)
        self.menuSeaborn_Theme.setObjectName(u"menuSeaborn_Theme")
        self.menuSeaborn_Font_Size = QMenu(self.menuFigure)
        self.menuSeaborn_Font_Size.setObjectName(u"menuSeaborn_Font_Size")
        self.menuSeaborn_Palette = QMenu(self.menuFigure)
        self.menuSeaborn_Palette.setObjectName(u"menuSeaborn_Palette")
        ...
        self.menuFigure.addAction(self.menuChange_Seaborn_Style.menuAction())
        self.menuFigure.addAction(self.menuSeaborn_Theme.menuAction())
        self.menuFigure.addAction(self.menuSeaborn_Font_Size.menuAction())
        self.menuFigure.addAction(self.menuSeaborn_Palette.menuAction())
        self.menuFigure.addAction(self.actionSeaborn_Settings)
        self.menuChange_Seaborn_Style.addAction(self.actionDark)
        self.menuChange_Seaborn_Style.addAction(self.actionLight)
        self.menuChange_Seaborn_Style.addAction(self.actionDarkGrid)
        self.menuChange_Seaborn_Style.addAction(self.actionLightGrid)
        self.menuChange_Seaborn_Style.addAction(self.actionTicks)
        self.menuSeaborn_Theme.addAction(self.actionPaper)
        self.menuSeaborn_Theme.addAction(self.actionTalk)
        self.menuSeaborn_Theme.addAction(self.actionNotebook)
        self.menuSeaborn_Theme.addAction(self.actionPoster)
        self.menuSeaborn_Font_Size.addAction(self.action1)
        self.menuSeaborn_Font_Size.addAction(self.action2)
        self.menuSeaborn_Font_Size.addAction(self.action3)
        self.menuSeaborn_Font_Size.addAction(self.action4)
        self.menuSeaborn_Font_Size.addAction(self.action5)
        self.menuSeaborn_Palette.addAction(self.actiondeep)
        self.menuSeaborn_Palette.addAction(self.actionblue)
        self.menuSeaborn_Palette.addAction(self.actionflare)
        self.menuSeaborn_Palette.addAction(self.actionhls)
        self.menuSeaborn_Palette.addAction(self.actionmako)
        self.menuSeaborn_Palette.addAction(self.actioncrest)
        self.menuSeaborn_Palette.addAction(self.actionmagma)
        self.menuSeaborn_Palette.addAction(self.actioncubehelix)
        self.menuSeaborn_Palette.addAction(self.actionlight_b)
        self.menuSeaborn_Palette.addAction(self.actionseagreen)
        self.menuSeaborn_Palette.addAction(self.actionspectral)
        self.menuSeaborn_Palette.addAction(self.actioncoolwarm)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuChange_Seaborn_Style.setTitle(QCoreApplication.translate("MainWindow", u"Seaborn Style", None))
        self.menuSeaborn_Theme.setTitle(QCoreApplication.translate("MainWindow", u"Seaborn Theme", None))
        self.menuSeaborn_Font_Size.setTitle(QCoreApplication.translate("MainWindow", u"Seaborn Font Size", None))
        self.menuSeaborn_Palette.setTitle(QCoreApplication.translate("MainWindow", u"Seaborn Palette", None))
