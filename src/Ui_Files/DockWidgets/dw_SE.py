...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.gridLayout_3.addWidget(self.fill_cols_pb, 3, 1, 1, 1)
        ...
        self.linear_fit_pb = QPushButton(self.tab_3)
        self.linear_fit_pb.setObjectName(u"linear_fit_pb")

        self.gridLayout_3.addWidget(self.linear_fit_pb, 3, 2, 1, 1)
    ...
    def retranslateUi(self, DockWidget):
        ...
        self.correction_combo.setItemText(0, QCoreApplication.translate("DockWidget", u"Zero From First", None))
        self.correction_combo.setItemText(1, QCoreApplication.translate("DockWidget", u"No Correction", None))
        ...
        self.skip_header_LE.setText(QCoreApplication.translate("DockWidget", u"2", None))
        ...
        self.lineEdit_3.setText(QCoreApplication.translate("DockWidget", u"99", None))
